...
def trainClassifierWrapper(method, beatFeatures, directories, modelName):
    ...
    aT.featureAndTrain(directories, 0.2, 0.2, aT.shortTermWindow, aT.shortTermStep,
...
def classifyFolderWrapper(inputFolder, modelType, modelName, outputMode=False):
    ...
    for i, h in enumerate(Histogram):
        my_dict[classNames[i]] = h
        #print "{0:20s}\t\t{1:d}".format(classNames[i], h) #uncomment this for detailed explanation
    return my_dict
